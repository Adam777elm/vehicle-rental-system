...
import Waverunner from "./pages/Waverunner";
import Superjet from "./pages/Superjet";
import Waveboat from "./pages/Waveboat";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/marine/waverunner"
          element={<Waverunner />}
        />

        <Route
          path="/marine/superjet"
          element={<Superjet />}
        />

        <Route
          path="/marine/waveboat"
          element={<Waveboat />}
        />
      ...
      <a href="https://wa.me/212774593031" className="whatsapp-float" target="_blank" rel="noopener noreferrer" aria-label="Contactez-nous sur WhatsApp">
