...
// HELPER: Dynamic colors generator
const getAvailableColors = (bike) => {
  const name = bike.name.toLowerCase();
  const category = bike.category.toLowerCase();
  
  if (name.includes("r1m")) {
    return [
  ...
  if (name.includes("raptor 700") || name.includes("raptor 110")) {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87" }
    ];
  }
  if (name.includes("raptor 450")) {
    return [
  ...
  if (name === "r1") {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87", image: "https://cdn2.yamaha-motor.eu/prod/product-assets/2024/YZF1000R1/2024-Yamaha-YZF1000R1-EU-Icon_Blue-360-Degrees-001-03_Mobile.jpg" },
      { name: "Tech Black (Noir Satiné)", value: "#111111", image: "https://cdn2.yamaha-motor.eu/prod/product-assets/2025/YZF1000R1COMP/2025-Yamaha-YZF1000R1COMP-EU-Tech_Black-360-Degrees-001-03.jpg" }
    ];
  }
  if (name === "r7") {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87", image: "https://cdn2.yamaha-motor.eu/prod/product-assets/2024/YZF700R7/2024-Yamaha-YZF700R7-EU-Icon_Blue-Studio-001-03.jpg" },
      { name: "Tech Black (Noir Satiné)", value: "#111111", image: "https://mifa-motors.ma/wp-content/uploads/2023/04/2024-Yamaha-YZF700R7-EU-Midnight_Black-Studio-001-03.jpg" }
    ];
  }
  if (name === "r9") {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87", image: "https://cdn2.yamaha-motor.eu/prod/product-assets/2026/YZF900R9/2026-Yamaha-YZF900R9-EU-Icon_Blue-360-Degrees-001-03_Mobile.jpg" },
      { name: "Tech Black (Noir Satiné)", value: "#111111", image: "https://mifa-motors.ma/wp-content/uploads/2025/07/2025-Yamaha-YZF900R9-EU-Tech_Black-360-Degrees-001-03.jpg" }
    ];
  }
  if (name.includes("r1") || name.includes("r9") || name.includes("r7")) {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87" },
  ...
  if (name === "mt-09") {
    return [
      { name: "Tech Black (Noir Satiné)", value: "#111111" },
      { name: "Ice Storm (Gris/Rouge)", value: "#e2e8f0", image: "https://mifa-motors.ma/wp-content/uploads/2021/04/2025-Yamaha-MT09A-35-EU-Ice_Storm-Studio-001-03-2.jpg" }
    ];
  }
  if (name === "mt-125") {
    return [
  ...
  if (name === "mt-07") {
    return [
      { name: "Tech Black (Noir Satiné)", value: "#111111" },
      { name: "Ice Storm (Gris/Rouge)", value: "#e2e8f0", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQN-G3x4wdhKyONWgDSWrLnrnrrqquVPoyZGTJukCRd7Q&s=10" }
    ];
  }
  if (name === "mt-10") {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgFvWn5_FohD-TWwpCp6Ie4iIuD4XvbtocMXY6FE6MmQ&s=10" },
      { name: "Ice Storm (Gris/Rouge)", value: "#e2e8f0" }
    ];
  }
  if (name === "mt-09 sp" || name === "mt-10 sp") {
    return [
      { name: "Icon Performance (Carbone/Bleu)", value: "#1e293b" }
    ];
  }
  if (name.includes("mt-") || category.includes("roadster")) {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87" },
      { name: "Tech Black (Noir Satiné)", value: "#111111" },
  ...
  if (name.includes("tracer") || category.includes("sport touring") || category.includes("touring")) {
    return [
  ...
  if (category === "motocross" || category === "enduro" || name.includes("yz") || name.includes("wr")) {
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87" }
    ];
  }
  if (name.includes("ténéré") || name.includes("adventure") || name.includes("off road") || category.includes("adventure") || category.includes("off road")) {
    if (name === "ténéré 700") {
      return [
        { name: "Icon Blue (Bleu Racing)", value: "#004b87", image: "https://mifa-motors.ma/wp-content/uploads/2026/05/6052_2.jpg" },
        { name: "Classic Sahara (Sable Rallye)", value: "#c2b280", image: "https://mifa-motors.ma/wp-content/uploads/2026/05/6052_1.jpg" }
      ];
    }
    return [
      { name: "Icon Blue (Bleu Racing)", value: "#004b87" },
  ...
  if (name.includes("tmax") || name.includes("xmax") || name.includes("nmax") || category.includes("scooter")) {
    return [
  ...
  if (category.includes("marine") || name.includes("cruiser") || name.includes("superjet") || name.includes("boat")) {
    return [
